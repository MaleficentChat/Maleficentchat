...
async function loadDiaval(){
  const el=$('diaval');
  if(!el) return;
  el.innerHTML=`<div class="diaval-shell"><div class="diaval-head"><div class="diaval-avatar">🖤</div><div><h2>Diaval</h2><p class="muted">Local assistant · no external API required</p></div><button class="mini danger" id="clearDiaval">Clear conversation</button></div><div id="diavalMessages" class="diaval-messages"></div><form id="diavalForm" class="diaval-composer"><input id="diavalInput" maxlength="2000" placeholder="Talk to Diaval…"><button class="primary">Send</button></form></div>`;
  try{
